export const FACE_LANDMARKS_LIPS: [number, number][] = [
...
export const FACE_LANDMARKS_LEFT_EYE: [number, number][] = [
    [263, 249], [249, 390], [390, 373], [373, 374], [374, 380], [380, 381],
    [381, 382], [382, 362], [263, 466], [466, 388], [388, 387], [387, 386],
    [386, 385], [385, 384], [384, 398], [398, 362]
];

export const FACE_LANDMARKS_LEFT_EYEBROW: [number, number][] = [
    [276, 283], [283, 282], [282, 295], [295, 285], [300, 293], [293, 334],
    [334, 296], [296, 336]
];

export const FACE_LANDMARKS_RIGHT_EYE: [number, number][] = [
    [33, 7], [7, 163], [163, 144], [144, 145], [145, 153], [153, 154],
    [154, 155], [155, 133], [33, 246], [246, 161], [161, 160], [160, 159],
    [159, 158], [158, 157], [157, 173], [173, 133]
];

export const FACE_LANDMARKS_RIGHT_EYEBROW: [number, number][] = [
    [46, 53], [53, 52], [52, 65], [65, 55], [70, 63], [63, 105], [105, 66],
    [66, 107]
];

export const FACE_LANDMARKS_FACE_OVAL: [number, number][] = [
...
export const FACE_LANDMARKS_CONTOURS: [number, number][] = [
    ...FACE_LANDMARKS_LIPS,
